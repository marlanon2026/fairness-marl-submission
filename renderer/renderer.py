...
class RobotouilleRenderer:
    ...
    def __init__(
        self, layout=[], players=[], window_size=np.array([512, 512]), render_fps=60, show_selected_player=True
    ):
        """
        ...
        self.canvas = RobotouilleCanvas(layout, players, window_size, show_selected_player=show_selected_player)
