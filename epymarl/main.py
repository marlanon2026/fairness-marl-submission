...
import sys
import torch as th
from envs import add_environment
...
if __name__ == "__main__":
    ...
    env_name_config = _get_config(params, "--env-name")
    note_config = _get_config(params, "--note")
    tags_config = _get_config(params, "--tags")
    group_config = _get_config(params, "--group")
    # config_dict = {**config_dict, **env_config, **alg_config}

    config_dict = recursive_dict_update(config_dict, env_config)
    config_dict = recursive_dict_update(config_dict, alg_config)
    config_dict["env_name"] = env_name_config
    config_dict["note"] = note_config
    config_dict["tags"] = tags_config.split(" ") if tags_config is not None else None
    config_dict["group"] = group_config

    add_environment(env_name_config)
    try:
