...
class PDDLEnv(gym.Env):
    ...
    def load_pddl(domain_file, problem_dir, operators_as_actions=False):
        ...
        for problem_file in sorted(problem_files):
            # print(f"DEBUG: About to call PDDLProblemParser with problem_file: {problem_file}")
        ...
        # print(f"DEBUG: Loaded {problems} problems from {problem_dir}")    
    ...
    def reset(self):
        ...
        """
        # print(f"DEBUG: Resetting PDDLEnv with problem index {self._problem_index_fixed} and problems {self.problems}")
