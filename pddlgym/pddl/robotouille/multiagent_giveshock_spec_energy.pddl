...
(:init
    ...
    (clear cpr_board1)
    (canmoveitem robot1)    (canmove robot1)    (cancompresschest robot1)    (cangiverescuebreaths robot1)    (cangiveshock robot1)    (canmoveitem robot2)    (canmove robot2)    (cancompresschest robot2)    (cangiverescuebreaths robot2)    (cangiveshock robot2)    (canmoveitem robot3)    (canmove robot3)    (cancompresschest robot3)    (cangiverescuebreaths robot3)    (cangiveshock robot3))
(:goal
   (or
       (and
           (isshocked patient1)
